...
public class StudentControllerTests {
	...
	public void getShouldFetchAHalDocument() throws Exception {
		...
		given(repository.findAll()).willReturn( //
				Arrays.asList( //
						new Student("Frodo", "Baggins", Gender.male, LocalDate.of(1991, 1, 1), "New York", "Computer Science & Technology", "167392019"), //
						new Student("Bilbo", "Baggins", Gender.female, LocalDate.of(2022, 3, 12), "Nanjing", "Physics", "163232144")));
